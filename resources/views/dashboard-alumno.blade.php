...
<script>
        ...
        document.querySelectorAll('.calendar-day').forEach(function (dayElement) {
            dayElement.addEventListener('click', function () {
                ...
                if (classes.hasOwnProperty(date)) {
                    ...
                    showNextClassToast(date, []); // Mostrar un toast de no hay clases
                }
            });
        });
    });
    ...
    function showNextClassToast(date, classes) {
        ...
        toastEl.style.maxWidth = '500px'; // Aumentar el ancho del toast
        toastEl.style.width = '100%'; // Para que ocupe el ancho disponible del contenedor
