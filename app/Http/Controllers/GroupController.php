...
class GroupController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $schools = School::all();
        $subjects = Subject::all(); // Carga todas las materias para la selección
    ...
    public function registerAttendance(Request $request, Group $group)
    {
        ...
        if ($currentTime->timestamp > $expiresAt) {
        ...
        $minutesLate = $currentTime->diffInMinutes(Carbon::createFromTimestamp($expiresAt)->subMinutes($group->qr_interval));
